 ...
 * @extends {ActorSheet}
 */
export class SubversionActorSheet extends ActorSheet {
  /** @override */
  ...
  /** @override */
  get template() {
    return `systems/subversion/templates/actor/actor-${this.actor.type}-sheet.hbs`;
  }
  ...
  async getData() {
    ...
    // Adding a pointer to CONFIG.SUBVERSION
    context.config = CONFIG.SUBVERSION;
